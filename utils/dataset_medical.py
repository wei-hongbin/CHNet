...
class Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # image = cv2.imread(self.root+'/images/'+name+'.png')[:,:,::-1].astype(np.float32)
        image = cv2.imread(self.root+'/images/'+name+'.jpg')[:,:,::-1].astype(np.float32)
